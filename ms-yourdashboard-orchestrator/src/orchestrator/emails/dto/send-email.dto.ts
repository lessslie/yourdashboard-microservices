...
export class EmailAttachmentDto {
  ...
  @IsString()
  @MaxLength(100, {
    message: 'Nombre del archivo no puede exceder 100 caracteres',
  })
  filename: string;
...
export class SendEmailDto {
  @ApiProperty({
    description:
      'Email remitente (debe ser una cuenta Gmail asociada al usuario autenticado)',
  ...
  @ArrayMaxSize(50, {
    message: 'Máximo 50 destinatarios principales permitidos',
  })
  @IsEmail(
    {},
    {
      each: true,
      message: 'Todos los destinatarios deben tener formato de email válido',
    },
  )
  to: string[];
  ...
  @IsEmail(
    {},
    { each: true, message: 'Todos los emails en CC deben ser válidos' },
  )
  cc?: string[];
  ...
  @IsEmail(
    {},
    { each: true, message: 'Todos los emails en BCC deben ser válidos' },
  )
  bcc?: string[];
  ...
  @MaxLength(100000, {
    message: 'Contenido no puede exceder 100,000 caracteres',
  })
  body: string;
  ...
  @MaxLength(100000, {
    message: 'Contenido HTML no puede exceder 100,000 caracteres',
  })
  bodyHtml?: string;
  ...
  @ApiProperty({
    description:
      'ID del email al que se responde (para mantener hilo de conversación) - opcional',
    required: false,
  ...
  @ApiProperty({
    description:
      'Referencias de emails previos en el hilo de conversación - opcional',
    required: false,
    type: [String],
