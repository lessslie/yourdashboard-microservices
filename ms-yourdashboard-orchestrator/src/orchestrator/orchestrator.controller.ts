    ...
    schema: {
      ...
      properties: {
        ...
        modules: {
          type: 'object',
          properties: {
            emails: { type: 'string', example: 'Gestión de emails via MS-Email' },
            calendar: { type: 'string', example: 'Gestión de calendario (próximamente)' },
            whatsapp: { type: 'string', example: 'Gestión de WhatsApp (próximamente)' }
          }
        },
        endpoints: {
          type: 'object',
